...
# bash <(cat ~/git_work/stroom-resources/bin/stack/lib/get_stroom.sh | sed 's/stroom_core_test/stroom_core_test/; s/stroom-stacks-v6.0-beta.31-5/stroom-stacks-v6.0-beta.28-9/; s/v6.0-beta.31-5/v6.0-beta.28-9/; s/cb75223b63545f6ef8c3b562d485b616955425a33fe71511a40ca68121ffd907  stroom_core_test-v6.0-beta.31-5.tar.gz/fc593474e2ee6b9a7f507303fc38522c6a4d1abf62e2ddc7af0f20d15b6baeb0  stroom_core_test-v6.0-beta.28-9.tar.gz/' )
...
main() {
  ...
  local -r stack_tag="stroom-stacks-v6.0-beta.31-5"
  local -r stack_version="v6.0-beta.31-5"
  local -r hash_file_contents="cb75223b63545f6ef8c3b562d485b616955425a33fe71511a40ca68121ffd907  stroom_core_test-v6.0-beta.31-5.tar.gz"
